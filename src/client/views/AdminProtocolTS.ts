...
export class AdminProtocolTS extends Vue {
    // #region -- referred props and methods by this page
    private readonly filePostParam: FileUploadParam = new FileUploadParam();
    private fileTypes: string[] = ACCEPTED_UPLOAD_FILE_TYPES;
    private fileSizeMLimit: number = LIMIT_FILE_SIZE_M;
    private onUploadSuccess(apiResult: ApiResult): void {
